...
_See code: [src/commands/configure.ts](https://github.com/tanookilabs/storyexporter/blob/v0.4.36/src/commands/configure.ts)_
...
_See code: [src/commands/dump.ts](https://github.com/tanookilabs/storyexporter/blob/v0.4.36/src/commands/dump.ts)_
